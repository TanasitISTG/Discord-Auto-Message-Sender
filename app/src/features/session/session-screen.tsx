                    ...
                    {appReadiness.blockingIssues.length > 0 || runtimeMessage ? (
                        <div className="space-y-3 rounded-xl border border-border/50 bg-background/50 p-4 text-sm shadow-xs backdrop-blur-xs">
                            {appReadiness.blockingIssues.map((issue) => (
                                <div key={issue} className="rounded-xl border border-amber-500/20 bg-amber-500/10 p-4 text-amber-100 shadow-xs">
                            ...
                            {runtimeMessage ? (
                                <div className="rounded-xl border border-red-500/20 bg-red-500/10 p-4 text-red-100 leading-relaxed shadow-xs">
                                    {runtimeMessage}
                                </div>
                            ) : null}
                        </div>
            ...
            <div className="grid gap-4">
                <Card>
                    ...
                    <CardContent className="space-y-3 text-sm">
                        ...
                        {session?.summary ? (
                            <div className="rounded-xl border border-border/50 bg-background/50 p-4 shadow-xs mt-2">
                        ...
                        {session?.stopReason ? (
                            <div className="rounded-xl border border-red-500/20 bg-red-500/10 p-4 text-red-200 shadow-xs mt-2">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-3">
                        {healthEntries.length === 0 ? (
                            ...
                            <div key={entry.channelId} className="rounded-xl border border-border/50 bg-background/50 p-4 text-sm shadow-xs transition-colors hover:bg-card/60">
