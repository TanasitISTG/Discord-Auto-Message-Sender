...
export function ChannelsCard({ channels, selectedChannelId, onAddChannel, onSelectChannel }: ChannelsCardProps) {
    return (
        <Card>
            <CardHeader>
                <CardTitle>Channels</CardTitle>
                <CardDescription>
                    Pick the channel you want to edit without stretching the page height around it.
                </CardDescription>
            </CardHeader>
