...
pub(crate) fn save_sender_state_record_unlocked(paths: &RuntimePaths, state: &SenderStateRecord) -> Result<(), String> {
...
pub(crate) fn update_sender_state_record<F>(paths: &RuntimePaths, updater: F) -> Result<SenderStateRecord, String>
where
